...
/*   Updated: 2021/04/24 14:13:41 by bwayfare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_spr_param_init(t_mprms *mprms, int i)
{
	...
	mprms->draw_spr.sprt_x - mprms->plr.dir_x * mprms->draw_spr.sprt_y);
	mprms->draw_spr.transf_y = mprms->draw_spr.nv_det * (-mprms->plr.pl_y *
	mprms->draw_spr.sprt_x + mprms->plr.pl_x * mprms->draw_spr.sprt_y);
	mprms->draw_spr.sprt_scrn_x = (int)((W / 2) * (1 +
	mprms->draw_spr.transf_x / mprms->draw_spr.transf_y));
	mprms->draw_spr.sprt_hght = abs((int)(H / (mprms->draw_spr.transf_y)));
